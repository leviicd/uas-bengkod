              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align:right;">
                    <a href="{{ route('jadwal.edit', $jadwal->id) }}" class="btn btn-warning btn-sm" title="Edit" style="width:32px;height:32px;padding:0;display:inline-flex;align-items:center;justify-content:center;border-radius:8px;">
